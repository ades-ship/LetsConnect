...
const JoinCreateChat = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center ">
      <div className="p-10 dark:border-gray-700 border w-full flex flex-col gap-5 max-w-md rounded dark:bg-gray-500 shadow">
        <div>
        ...
        <div className="flex justify-center gap-2 mt-4">
          <button
            onClick={joinChat}
            className="px-3 py-2 dark:bg-blue-500 bg-blue-500 hover:bg-blue-800 hover:dark:bg-blue-800 rounded-full"
          >
            Join Room
          </button>
          <button
            onClick={createRoom}
            className="px-3 py-2 dark:bg-orange-500 bg-orange-500 hover:bg-orange-800 hover:dark:bg-orange-800 rounded-full"
          >
            Create Room
          </button>
        </div>
